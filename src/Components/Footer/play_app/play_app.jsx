...
const DownloadCard = ({ title, description, googleLink, appleLink }) => (
  <div className="card">
    <span className="small-text">Download Now!</span>
    <span className="title">{title}</span>
    <span className="desc">{description}</span>
    <div className="buttons">
      <a href={googleLink} className="button" aria-label="Download from Google Play">
        <span className="icon">
          <svg
            width="34"
            height="34"
      ...
      <a href={appleLink} className="button" aria-label="Download from App Store">
        <span className="icon">
          <svg
            width="34"
            height="34"
  ...
  return (
    <div>
      <DownloadCard 
        ...
        description="Download the FandomX app for iOS & Android to book tickets, manage venues, and access exclusive sports merchandise." 
        googleLink="#" 
        appleLink="#" 
      />
    </div>
